// This plugin taken from https://github.com/rust-adventure/asteroids/blob/yt-2024-04-01/src/kenney_assets.rs Thanks to https://github.com/ChristopherBiscardi
