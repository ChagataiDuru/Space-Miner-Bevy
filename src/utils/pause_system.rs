// This plugin taken from https://github.com/rust-adventure/asteroids/blob/yt-2024-04-01/src/ui/pause.rs Thanks to https://github.com/ChristopherBiscardi
use bevy::prelude::*;

use crate::{
    utils::asset_loader::ImageAssets,
    GameState
}; 
